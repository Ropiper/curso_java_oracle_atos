<%-- 
    ...
    Author     : IEUser
--%>
<%@page import="modelo.logica.IUsuarioDAO"%>
<%@page import="modelo.persistencia.DerbyDBUsuario"%>
    ...
    <body>
        ...
        <div border="2">
                ...
                <form action="usuarios.do" method="post" name="form_<%= usu.getId() %>">
                    ...
                    <input type="submit" value="EDIT" onclick="Array.from(document.getElementsByClassName('method')).forEach((thisImput) => {thisImput.value='PUT';})"/>
                    <input type="submit" value="ELIM" onclick="Array.from(document.getElementsByClassName('method')).forEach((thisImput) => {thisImput.value='DELETE';})"/><br/>
                </form>
                <%
                    }
                %>
