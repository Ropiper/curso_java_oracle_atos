...
public class ParamServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr><td>Nombre:</td><td><input type='text' name='nom' id='nom' size='25'/></td></tr>");
            out.println("<tr><td>Edad:</td><td><input type='number' name='ed' id='ed' size='25'/></td></tr>");
            out.println("</table>");
